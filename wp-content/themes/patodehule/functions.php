...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        // PATO JS
        wp_register_script('patojs', get_template_directory_uri() . '/js/pato.js');
        wp_enqueue_script('patojs');
...
function html5blank_styles()
{
    ...
    wp_register_style('pato', get_template_directory_uri(). '/css/pato.css');
    wp_enqueue_style('pato');
}
...
// FUNCION ICONO ANIMADO
function icon_burguer() {
    echo '<label class="toggle" id="boton-menu"><input type="checkbox">
            <div>
                <div>
                    <span></span>
                    <span></span>
